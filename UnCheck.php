...
quest_relic_ancientdrill_unlock_1,現在你已經掌握了護盾和穿透的要義。我覺得是時候去尋找一個強大的遺物來讓你好好實踐一下你的知識了。
...
quest_relic_drakescalearmor_unlock_2,我一直在努力搜索有沒有什麼遺物可以幫助你，我想我已經找到了一套有用的鎧甲。
quest_relic_drakescalearmor_unlock_3,問題是它在一座，嗯，一座不那麼平靜的火山裡。
quest_relic_drakescaleboots_complete_1,為什麼我們總在任務全部結束之後才能拿到這件有用的遺物呢？
...
quest_relic_staffofsummoning_unlock_1,你們在過去的任務中經常使用召喚物，我想我已經發現了能幫上你的遺物的位置。
...
quest_relic_steelring_list,探尋石板城下方的遺物
...
quest_travel_shaderest_intro,你的聯絡人已經告訴你陰涼休息地被最近興起的暗影聯盟邪教所控制。這裡的謠言滿天飛，說邪教徒們能接觸到被禁止的巫術知識，但任何膽敢詢問他們的人都會很快被處理掉。你一路尋找到城鎮東部的一個地穴邊，在這附近可以看到獻祭的跡象，牆壁上畫著邪惡的魔符。你聽到裡面傳來吟唱聲，決定往下冒險…
...
scenario_relic_loot_objective,拾取遺物
...
scenario_relic_orbofdawn_success_3,那遺物一定能用來對付暗夜惡魔！
scenario_relic_orbofdawn_win_objective,消滅所有房間裡的烈光惡魔。
scenario_relic_orboftwilight_room_2_1,這個區域同樣存在岩石守衛，儘量避開他們。你只需要消滅暗夜惡魔並取得遺物。
...
scenario_relic_orboftwilight_success_3,這個遺物在我們對抗一些光元素的惡魔時應該能派上用場！
